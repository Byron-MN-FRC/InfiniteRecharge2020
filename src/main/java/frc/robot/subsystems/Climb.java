...
private WPI_TalonFX buddyBackWinch;
    ...
    public final SupplyCurrentLimitConfiguration currentLimiting = new SupplyCurrentLimitConfiguration(
            ClimbConstants.kEnableCurrentLimiting_BS, ClimbConstants.currentLimit,
            ClimbConstants.thresholdLimit, ClimbConstants.thresholdTime);
...
buddyBackWinch = new WPI_TalonFX(15);
    ...
    public void periodic() {
        ...
        SmartDashboard.putBoolean("CM/Climb Mode", cMode);
        SmartDashboard.putBoolean("DT/Climb Mode", cMode);
        SmartDashboard.putBoolean("In Proximity", barProximity());
    }
    ...
    public boolean barProximity(){
        SmartDashboard.putNumber("Proximity", getProximity());
        if (getProximity() >= 3000){
            return true;
        }
        else {
            return false; 
