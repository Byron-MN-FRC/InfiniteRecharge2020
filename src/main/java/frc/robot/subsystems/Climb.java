...
public class Climb extends Subsystem {
    ...
    private Solenoid buddyPistion;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public Climb() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        buddyWinchBack = new WPI_VictorSPX(ClimbConstants.buddyWinchBackID);

        buddyWinchFront = new WPI_VictorSPX(ClimbConstants.buddyWinchFrontID);

        hookMotor = new WPI_TalonSRX(ClimbConstants.hookMotorID);

        winchMotor = new WPI_TalonSRX(ClimbConstants.winchClimbID);

        proximitySensor = new AnalogInput(3);
        addChild("ProximitySensor", proximitySensor);
        
        buddyPistion = new Solenoid(10, 0);
        addChild("buddyPistion",buddyPistion);
