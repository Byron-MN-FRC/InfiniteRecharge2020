...
addChild("LeftBuddyServo",leftBuddyServo);
    ...
    public void periodic() {
        ...
        SmartDashboard.putBoolean("Climb Mode", cMode);
    }
    ...
    public void pullBuddyUp() {
        ...
        buddyWinchBack.set(0.3);
        buddyWinchFront.set(0.4);
    }
    ...
    public Boolean atHeight() {
        //ouble currentEncoderUnits = hookMotor.getSelectedSensorPosition(ClimbConstants.kPIDLoopIdx);
    ...
    public void stopBuddyWinch() {
        buddyWinchBack.set(0);
        buddyWinchFront.set(0);
    }
