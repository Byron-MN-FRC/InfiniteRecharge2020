...
private DigitalInput limitSwitchDown;
    ...
    private double masterShootRPM = 2500;
...
addChild("limitSwitchDown",limitSwitchDown);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        SmartDashboard.putNumber("shooter/targetVelocity", 500);
        SmartDashboard.putNumber("shooter/P", .4);
        SmartDashboard.putNumber("shooter/I", .00001);
        SmartDashboard.putNumber("shooter/D", 0);
        SmartDashboard.putNumber("shooter/F", .0495);
        SmartDashboard.putNumber("shooter/targetPosition", 3000);
    ...
    public void fireMotor() {
        ...
        // this is dangerous as we are not looking at the state of the hoodmasterHoodPos
    ...
    public boolean ready2Shoot(final double rpms, final double hoodEncoderUnits) {
        ...
        if (++loop >= 15) {
            toConsoleln("ShootTarget=" + rpmToVelocityPer100ms(rpms) + " Cur="
                ...
                + shootMotor.getClosedLoopError(BallShooterConstants.kPIDLoopIdx) + " InThreshold "
                + iwthresh);
            toConsoleln("hoodTarget=" + hoodEncoderUnits + " Cur="
                + hoodMotor.getSelectedSensorPosition(BallShooterConstants.kPIDLoopIdx) + " Err="
                + hoodMotor.getClosedLoopError(BallShooterConstants.kPIDLoopIdx) + " hood at position="
                + hp);
            toConsoleln
            ("Returning "+ (iwthresh && hp));
        }
    ...
    public void testShootMotor() {
        ...
        double targetVelocity_UnitsPer100ms = rpmToVelocityPer100ms(targetRPMs);
        ...
        double targetVelocity_UnitsPer100ms = rpmToVelocityPer100ms(targetPos);
