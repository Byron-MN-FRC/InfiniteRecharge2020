...
public class BallShooter extends Subsystem {
   ...
   private double timer = 0;
    ...
    public void prepareToShoot(double rpms, double hoodEncoderUnits) {
        ...
        System.out.print("tgt:" + velocityPer100ms + " err:" + shootMotor.getClosedLoopError(Constants.kPIDLoopIdx));
        System.out.println(" shoot motor : " + rpms + " hoodenc" + hoodEncoderUnits);
    ...
    public boolean ready2Shoot(double rpms, double hoodEncoderUnits) {
        ...
        double currentRPMs = Math.abs(velocityPer100msToRpm(shootMotor.getSelectedSensorVelocity()));
