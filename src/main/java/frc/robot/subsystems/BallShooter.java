...
hoodMotor = new WPI_TalonSRX(6);
    ...
    public Boolean targetEncoder() {
        ...
        if (Math.abs(currentEncoderUnits - BallShooterConstants.hoodUpEncoderUnits)  < 500) {
            return true;
        }
        return false;
    }
    public void hoodUp(){
        hoodMotor.set(ControlMode.MotionMagic, 5000);
    ...
    public void hoodMotorConfig() {
        ...
        hoodMotor.configMotionCruiseVelocity(15000, BallShooterConstants.kTimeoutMs);
        hoodMotor.configMotionAcceleration(6000, BallShooterConstants.kTimeoutMs);
