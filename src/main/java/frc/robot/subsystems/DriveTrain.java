...
public class DriveTrain extends Subsystem {
    ...
    private Solenoid coolingSolenoidMotors;
    ...
    TalonFXInvertType _rightInvert = TalonFXInvertType.Clockwise; // Same as invert = "false"
    TalonFXInvertType _leftInvert = TalonFXInvertType.CounterClockwise; // Same as invert = "true"
    TalonFXConfiguration _leftConfig = new TalonFXConfiguration();
    TalonFXConfiguration _rightConfig = new TalonFXConfiguration();

    /**
     * One instance of pixyData is created to run during the entire match. It can be
     * called upon at any time to provied the coordinates of yellow balls It can
     * see.
     */
    public getPixyData pixyData = new getPixyData();
    ...
    public DriveTrain() {
        ...
        coolingSolenoidMotors = new Solenoid(10, 6);
        addChild("coolingSolenoidMotors", coolingSolenoidMotors);
    ...
    public void initDefaultCommand() {
        ...
        // Start pulling data from the pixy
        pixyData.start();
        SmartDashboard.putData("PixyData", pixyData);
    }
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("RMaster Amps", rightMaster.getSupplyCurrent());
        SmartDashboard.putNumber("RFollow Amps", rightFollower.getSupplyCurrent());
        SmartDashboard.putNumber("LMaster Amps", leftMaster.getSupplyCurrent());
        SmartDashboard.putNumber("LFollow Amps", leftFollower.getSupplyCurrent());
        SmartDashboard.putNumber("RMStator Stator", rightMaster.getStatorCurrent());
        ...
        if (Constants.kDebug_DT)
            SmartDashboard.putBoolean("Pigeon Ready?",
                    (pigeon.getState() == PigeonIMU.PigeonState.Ready) ? true : false);
        if (Constants.kDebug_DT)
            SmartDashboard.putNumber("Pigeon Angle", fusionStatus.heading);
    ...
    public boolean closedLoopTurnComplete(double target) {
        ...
        if (Constants.kDebug_DT)
            SmartDashboard.putNumber("Turn Distance Remaining", Math.abs(ypr[0] - target));
