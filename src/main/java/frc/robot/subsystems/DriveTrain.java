...
public class DriveTrain extends Subsystem {
    ...
    private DoubleSolenoid leftShiftSolemoid;
    ...
    public DriveTrain() {
        ...
        leftShiftSolemoid = new DoubleSolenoid(10, 2, 3);
        addChild("leftShiftSolemoid", leftShiftSolemoid);

        rightShiftSolenoid = new DoubleSolenoid(10, 0, 1);
        addChild("rightShiftSolenoid", rightShiftSolenoid);
    ...
    public void periodic() {
		...
		SmartDashboard.putNumber("Right Amps", rightMasterFalcon.getStatorCurrent());
		...
		SmartDashboard.putNumber("Left Amps", leftMasterFalcon.getStatorCurrent());
    ...
    public void shiftUp() {
        leftShiftSolemoid.set(Value.kForward);
        rightShiftSolenoid.set(Value.kForward);
    }

    public void shiftDown() {
        leftShiftSolemoid.set(Value.kReverse);
