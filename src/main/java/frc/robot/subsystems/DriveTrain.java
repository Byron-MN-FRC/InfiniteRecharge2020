...
tankDrive.setMaxOutput(1.0);
    ...
    public void periodic() {
        ...
        //SmartDashboard.putNumber("Right Stator Amps", rightMaster.getStatorCurrent());
    ...
    public void motorConfig() {
        motorConfigFalcon();
        // rightSlaveFalcon.follow(rightMaster);
    ...
    public final SupplyCurrentLimitConfiguration currentLimitingFalcons = new SupplyCurrentLimitConfiguration(
            Constants.enable, SmartDashboard.getNumber(Constants.kAmpLimitStr, 2),
            SmartDashboard.getNumber(Constants.kAmpPeakStr, 3), Constants.threshholdTime);
    ...
    public void motorConfigFalcon() {
        ...
        //BD Current         rightMaster.configSupplyCurrentLimit(currentLimitingFalcons);
    ...
    public void zeroSensors() {
      //BD  SupplyCurrentLimitConfiguration changeLimit = new SupplyCurrentLimitConfiguration(Constants.enable,
         //       SmartDashboard.getNumber(Constants.kAmpLimitStr, 2), SmartDashboard.getNumber(Constants.kAmpPeakStr, 3),
           //     Constants.threshholdTime);
