...
addChild("coolingSolenoidMotors",coolingSolenoidMotors);
    ...
    public void motorConfigFalconSlow() {
        // Factory default all motors initially
        rightMaster.configFactoryDefault();
        rightFollower.configFactoryDefault();
        leftMaster.configFactoryDefault();
        ...
        // Motion Magic Configs
        _rightConfig.motionAcceleration = 3250; // (distance units per 100 ms) per second
        _rightConfig.motionCruiseVelocity = 7500; // distance units per 100 ms
