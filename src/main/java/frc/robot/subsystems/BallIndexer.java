...
public class BallIndexer extends Subsystem {
    private int indexedBallCount = 3;
    ...
    // public static void periodic(boolean readBallPresent){
    //     ballPresent = readBallPresent;

    //     // Do the following if there has not been a ball arrival.
    //     if (!ballArrived){
    //         //ballArrived = false
    //         System.out.println("Checking to see if ball has arrived.");
    //         if (ballPresent && !prevBallPresent) {
    //             ballArrived = true;
    //             System.out.println("--> Ball has arrived");
    //         }
    //     } else {
    //         //ballArrived = true, test to see if the ball has left
    //         System.out.println("Checking to see if ball has left.");
    //         if (!ballPresent && prevBallPresent) {
    //             System.out.println("Ball has left. -->");
    //             ballArrived = false;
    //             System.out.println("Decrementing ball count.");
    //         }
    //     }
    //     prevBallPresent = ballPresent;
