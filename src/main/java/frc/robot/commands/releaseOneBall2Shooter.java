 ...
 *
 */
public class releaseOneBall2Shooter extends Command {
    ...
    protected boolean isFinished() {
        // Ball is present to be be advanced
        return (isTimedOut() || Robot.ballIndexer.ballCount() <= (NumberOfBalls-1));
    }
