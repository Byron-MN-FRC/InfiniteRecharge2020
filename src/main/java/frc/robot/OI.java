...
btnAcquire.whileHeld(new startAcquisition());
        ...
        SmartDashboard.putData("reverseAcquisition", new reverseAcquisition());
        SmartDashboard.putData("climbMode", new climbMode());
        SmartDashboard.putData("releaseWinch", new releaseWinch());
        SmartDashboard.putData("chasePowerCells", new chasePowerCells());
        SmartDashboard.putData("chasePowerCellsGroup", new chasePowerCellsGroup());
