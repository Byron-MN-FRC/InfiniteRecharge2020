...
btnStopShooting = new JoystickButton(xBoxController, 6);
btnStopShooting.whenReleased(new stopShooting());
btnStopFlyWheel = new JoystickButton(xBoxController, 5);
btnStopFlyWheel.whenReleased(new stopFlyWheel());
btnSpinUp = new JoystickButton(xBoxController, 5);
...
btnStartShooter = new JoystickButton(xBoxController, 6);
