...
btnBuddyUp = new JoystickButton(climbJoystick, 8);
btnBuddyUp.whileHeld(new pullBuddyUp());
btnDeployNet = new JoystickButton(climbJoystick, 7);
btnDeployNet.whenPressed(new deployNet());
btnDeployLinearSlide = new JoystickButton(climbJoystick, 4);
btnDeployLinearSlide.whenPressed(new deployLinearSlide());
btnRobotUp = new JoystickButton(climbJoystick, 1);
btnRobotUp.whileHeld(new pullRobotUp());
joystick = new Joystick(0);

btnLimeLightTurn = new JoystickButton(joystick, 10);
