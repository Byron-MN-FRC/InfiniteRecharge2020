...
public JoystickButton btnReleaseBuddyWinch;
...
btnReleaseBuddyWinch = new JoystickButton(accessoriesJoystick, 10);
btnReleaseBuddyWinch.whileHeld(new stopBuddyUpFront());
...
btnAcquire.whileHeld(new startAcquisition());
        ...
        SmartDashboard.putData("RaiseLinearSlide", new RaiseLinearSlide());
